...
defect_ref = {}
portfolio_item_ref = {}
workspace_name = "rich.feather@broadcom.com-2019-29-Nov"
server_name = "sales"
...
def main(args):
	...
	api_key 	= ""
	server_name = "sales"
	workspace_name = "rich.feather@broadcom.com-2019-Nov-29"
	dataset_name = "Test"
	debug = 1
	...
	#login_name = "thomas.mcquitty@acme.com"
		...
		print "server name is %s" % server_name
        	print "workspace name is %s" % workspace_name
	...
	objects = ["Release", "Iteration", "PreliminaryEstimate", "Theme", "Initiative", "Feature", "Story", "Defect", "TestFolder", "TestSet", "TestCase", "TestCaseStep", "TestCaseResult", "Task", "FundingIncrement", "Risk", "Investment"]
 
	getPreliminaryEstimateRef(val["preliminaryestimate"])
