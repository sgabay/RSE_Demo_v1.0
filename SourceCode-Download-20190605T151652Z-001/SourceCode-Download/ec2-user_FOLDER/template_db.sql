...
INSERT INTO `config_object` VALUES (1,1,2,'portfolioitem/feature','epic',NULL,2,NULL,'AC to Jira Feature (optional: add query)'),(2,1,2,'Iteration','sprint','(Project.Name = \"Consumer Site\")',1,NULL,'AC to Jira Iterations (update Query)'),(3,2,1,'epic','portfolioitem/feature','project=(JIRA PROJECT KEY)',5,'2018-05-07 16:43:48','Jira to AC Epic ID, Status (update query)'),(4,1,2,'hierarchicalrequirement','story',NULL,3,NULL,'AC to Jira Stories (update mapping)'),(5,1,2,'defect','bug',NULL,4,NULL,'AC to Jira Defects (update mapping)'),(6,2,1,'story','hierarchicalrequirement','project=(JIRA PROJECT KEY)',6,'2018-05-07 16:43:50','Jira to AC Stories (update query)'),(7,2,1,'bug','defect','project=(JIRA PROJECT KEY)',7,NULL,'Jira to AC bugs (update query)');
...
INSERT INTO `config_object_field` VALUES (1,'summary','Name',NULL,NULL,'','',1,'\0'),(2,'description','Description',NULL,NULL,'','',1,'\0'),(3,'Team','Project',NULL,'(VALIDATE)','','',1,'\0'),(4,'project',NULL,NULL,'(JIRA_KEY)','',NULL,1,'\0'),(5,'Epic Name','FormattedID',NULL,NULL,'','',1,'\0'),(6,'ACRank','DragAndDropRank',NULL,NULL,'','',1,'\0'),(7,'status','State',NULL,'(VALIDATE)','','',1,'\0'),(8,'Release','Release',NULL,'(VALIDATE/SET)','','',1,'\0'),(9,'Name','Name',NULL,NULL,'','',2,'\0'),(10,'startDate','StartDate',NULL,NULL,'','',2,'\0'),(11,'endDate','EndDate',NULL,NULL,'','',2,'\0'),(12,'boardName',NULL,NULL,'(BOARD NAME)','','',2,'\0'),(13,'c_JiraID','key',NULL,NULL,'','',3,'\0'),(14,'State','status',NULL,NULL,NULL,'',3,'\0'),(15,'summary','Name',NULL,NULL,'','',4,'\0'),(16,'description','Description',NULL,NULL,'','',4,'\0'),(17,'sprint','Iteration',NULL,NULL,'','',4,'\0'),(18,'epic link','PortfolioItem','rallyToJiraObjectLookup',NULL,'','',4,'\0'),(19,'story points','PlanEstimate',NULL,NULL,'','',4,'\0'),(20,'status','ScheduleState',NULL,'(VALIDATE) To Do','','',4,'\0'),(21,'Team','Project',NULL,'(VALIDATE)','','',4,'\0'),(22,'project',NULL,NULL,'(JIRA KEY)','','',4,'\0'),(23,'ACID','FormattedID',NULL,NULL,'','',4,'\0'),(24,'Release','Release',NULL,'(VALIDATE)','','',4,'\0'),(25,'summary','Name',NULL,NULL,'','',5,'\0'),(26,'description','Description',NULL,NULL,'','',5,'\0'),(27,'project',NULL,NULL,'(JIRA KEY)','',NULL,5,'\0'),(28,'sprint','Iteration',NULL,NULL,'','',5,'\0'),(29,'story points','PlanEstimate',NULL,NULL,'','',5,'\0'),(30,'status','ScheduleState',NULL,'(VALIDATE)','','',5,'\0'),(31,'ACID','FormattedID',NULL,NULL,'','',5,'\0'),(32,'Team','Project',NULL,'(VALIDATE)','','',5,'\0'),(33,'Name','summary',NULL,NULL,'','',6,'\0'),(34,'Description','description',NULL,NULL,'','',6,'\0'),(35,'Project','Team',NULL,'(VALIDATE)','','',6,''),(36,'PortfolioItem','epic link','jiraToRallyObjectLookup',NULL,'','',6,'\0'),(37,'Iteration','sprint',NULL,NULL,'','',6,'\0'),(38,'ScheduleState','status',NULL,'(VALIDATE)','','',6,'\0'),(39,'PlanEstimate','story points',NULL,NULL,'','',6,'\0'),(40,'c_JiraID','key',NULL,NULL,'','',6,'\0'),(41,'Release','Release',NULL,'(VALIDATE)','','',6,'\0'),(42,'summary','Name',NULL,NULL,'','',7,'\0'),(43,'description','Description',NULL,NULL,'','',7,'\0'),(44,'Team','Project',NULL,'(VALIDATE)','','',7,''),(45,'sprint','Iteration',NULL,NULL,'','',7,'\0'),(46,'status','ScheduleState',NULL,'(VALIDATE)','','',7,'\0'),(47,'story points','PlanEstimate',NULL,NULL,'','',7,'\0'),(48,'key','c_JiraID',NULL,NULL,'','',7,'\0'),(49,'status','State',NULL,'(VALIDATE)','','',7,'\0');
...
-- Dump completed on 2018-06-06  9:13:28
